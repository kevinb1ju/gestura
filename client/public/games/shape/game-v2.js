...
function handleGameGesture(indexFingerTip) {
  ...
  // Since the video is mirrored, we flip the x coordinate
  // The x position maps across the entire screen width
  // The y position maps across the entire screen height
...
function startGame() {
  ...
  if (useGestureControl && hands) {
    // Initialize game camera - hands instance is already created
