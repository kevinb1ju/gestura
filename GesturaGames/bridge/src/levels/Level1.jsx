...
const Level1 = ({ onComplete, lives, onWrong }) => {
    ...
    return (
        <div className="relative w-screen h-screen bg-sky-100 overflow-hidden cursor-crosshair font-game">
            ...
            <div className="absolute top-8 left-8 flex gap-4 z-20 items-start">
                <div className="p-6 bg-white/90 rounded-3xl shadow-xl border-b-8 border-sky-200 transform hover:scale-105 transition-transform flex items-center gap-6">
                    <div>
